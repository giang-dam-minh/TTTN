<%@ Page Title="" Language="C#" MasterPageFile="~/webForm/MasterPage.Master" AutoEventWireup="true" CodeBehind="sale-off.aspx.cs" Inherits="GUI.danh_muc.sale_off" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pull-left headerLine">
        <a href="#" title="Danh sách sản phẩm">Danh sách sản phẩm Sale Off</a>
    </div>
